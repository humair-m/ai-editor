...
def explain_error(code: str, stderr: str, model="deepseek") -> str:
    if not stderr.strip():
        return "No error to explain."

    prompt = f"""Analyze this Python error and explain the cause with a possible fix.
